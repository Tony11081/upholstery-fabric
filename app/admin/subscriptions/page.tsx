...
export default async function AdminSubscriptionsPage() {
  ...
  if (!session?.user?.email) {
    return <AdminAuthState variant="signin" callbackUrl="/admin/subscriptions" />;
  }
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        <h1 className="font-display text-3xl leading-tight">订阅</h1>
        <p className="text-sm text-muted">跟踪库存、价格与上新提醒订阅。</p>
      </div>
